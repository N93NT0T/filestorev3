...
@Bot.on_message((filters.document | filters.photo | filters.video | filters.audio) & filters.incoming & ~filters.edited & ~filters.channel & ~filters.chat(Config.DB_CHANNEL))
